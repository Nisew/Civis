    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (sa) {
            ...
            case "listJoinedEvents":
                ...
                ArrayList<Evento> listaEventosInscrito = new ArrayList<>();
                ...
                request.setAttribute("listaEventosInscritos", listaEventosInscrito);
            ...
            case "listInscritos":
                ...
                int idEvento = Integer.parseInt(idevento);

                try {
                    listaAyudantes = aydb.listInscritos(idEvento);
                } catch (SQLException ex) {
                    ex.printStackTrace();
                }
                
                request.setAttribute("listaAyudantes", listaAyudantes);
                rd = request.getRequestDispatcher("inscritos.jsp");
                rd.forward(request, response);
        }
    }
